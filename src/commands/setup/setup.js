...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const fields = [
        { name: t('setup.roles'), value: t('setup.created-skipped', { created: result.rolesCreated, skipped: result.rolesSkipped }) },
        { name: t('setup.categories'), value: t('setup.created-skipped', { created: result.categoriesCreated, skipped: result.categoriesSkipped }) },
        { name: t('setup.channels'), value: t('setup.created-skipped', { created: result.channelsCreated, skipped: result.channelsSkipped }) },
      ];
      ...
      await interaction.editReply({
        content: t('setup.setupFailed', { error: error.message }),
      });
    }
  },
};
