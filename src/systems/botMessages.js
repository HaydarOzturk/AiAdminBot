...
const TEMPLATE_I18N = {
  en: {
    ...
    streamLive: { name: 'Stream Announcement (Live)', desc: 'Template for live stream announcements',
      author: '🔴 {user} is LIVE!',
      title: '📺 {stream_title}', body: '**{user}** is now live! Come watch and show your support!',
      fields: [
        { name: 'Platform Status', value: '{platforms_status}' },
      ],
      footer: '' },
  ...
  tr: {
    ...
    streamLive: { name: 'Yayın Duyurusu (Canlı)', desc: 'Canlı yayın duyuru şablonu',
      author: '🔴 {user} şu anda YAYINDA!',
      title: '📺 {stream_title}', body: '**{user}** şu anda yayında! Gel izle ve destek ol!',
      fields: [
        { name: 'Platform Durumu', value: '{platforms_status}' },
      ],
      footer: '' },
  ...
  de: {
    ...
    streamLive: { name: 'Stream-Ankündigung (Live)', desc: 'Vorlage für Live-Stream-Ankündigungen',
      author: '🔴 {user} ist LIVE!',
      title: '📺 {stream_title}', body: '**{user}** ist jetzt live! Komm vorbei und unterstütze!',
      fields: [{ name: 'Plattform-Status', value: '{platforms_status}' }],
  ...
  es: {
    ...
    streamLive: { name: 'Anuncio de Stream (En Vivo)', desc: 'Plantilla para streams en vivo',
      author: '🔴 ¡{user} está EN VIVO!',
      title: '📺 {stream_title}', body: '¡**{user}** está en vivo ahora! Ven a ver y apoyar!',
      fields: [{ name: 'Estado de Plataforma', value: '{platforms_status}' }],
  ...
  fr: {
    ...
    streamLive: { name: 'Annonce de Stream (En Direct)', desc: 'Modèle pour les streams en direct',
      author: '🔴 {user} est EN DIRECT !',
      title: '📺 {stream_title}', body: '**{user}** est en direct maintenant ! Venez regarder et soutenir !',
      fields: [{ name: 'Statut Plateforme', value: '{platforms_status}' }],
  ...
  pt: {
    ...
    streamLive: { name: 'Anúncio de Stream (Ao Vivo)', desc: 'Modelo para streams ao vivo',
      author: '🔴 {user} está AO VIVO!',
      title: '📺 {stream_title}', body: '**{user}** está ao vivo agora! Venha assistir e apoiar!',
      fields: [{ name: 'Status da Plataforma', value: '{platforms_status}' }],
  ...
  ru: {
    ...
    streamLive: { name: 'Анонс Стрима (Прямой Эфир)', desc: 'Шаблон для прямых трансляций',
      author: '🔴 {user} В ЭФИРЕ!',
      title: '📺 {stream_title}', body: '**{user}** сейчас в прямом эфире! Приходите смотреть!',
      fields: [{ name: 'Статус Платформы', value: '{platforms_status}' }],
  ...
  ar: {
    ...
    streamLive: { name: 'إعلان بث (مباشر)', desc: 'قالب للبث المباشر',
      author: '🔴 {user} مباشر الآن!',
      title: '📺 {stream_title}', body: '**{user}** يبث مباشرة الآن! تعال شاهد وادعم!',
      fields: [{ name: 'حالة المنصة', value: '{platforms_status}' }],
...
function getTemplates(guildId) {
  ...
  return [
    ...
    { id: 'stream-live', name: s('streamLive').name, description: s('streamLive').desc, messageType: 'stream-announcement',
      content: { author: s('streamLive').author || '', title: s('streamLive').title, description: s('streamLive').body, color: '#ff0000',
        fields: (s('streamLive').fields || []).map(f => ({ ...f, inline: false })),
