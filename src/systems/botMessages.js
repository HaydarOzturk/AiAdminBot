...
const TEMPLATE_I18N = {
  ...
  de: {
    ...
    streamLive: { name: 'Stream-Ankündigung (Live)', desc: 'Vorlage für Live-Stream-Ankündigungen',
      title: '🔴 {user} ist LIVE!', body: '📺 **{title}**\n\n**{user}** ist jetzt live! Komm vorbei und unterstütze!',
      fields: [{ name: 'Plattform-Status', value: '🟢 **{platform}** — LIVE • 🎮 **{game}**' }],
  ...
  es: {
    ...
    streamLive: { name: 'Anuncio de Stream (En Vivo)', desc: 'Plantilla para streams en vivo',
      title: '🔴 ¡{user} está EN VIVO!', body: '📺 **{title}**\n\n¡**{user}** está en vivo ahora! Ven a ver y apoyar!',
      fields: [{ name: 'Estado de Plataforma', value: '🟢 **{platform}** — EN VIVO • 🎮 **{game}**' }],
  ...
  fr: {
    ...
    streamLive: { name: 'Annonce de Stream (En Direct)', desc: 'Modèle pour les streams en direct',
      title: '🔴 {user} est EN DIRECT !', body: '📺 **{title}**\n\n**{user}** est en direct maintenant ! Venez regarder et soutenir !',
      fields: [{ name: 'Statut Plateforme', value: '🟢 **{platform}** — EN DIRECT • 🎮 **{game}**' }],
  ...
  pt: {
    ...
    streamLive: { name: 'Anúncio de Stream (Ao Vivo)', desc: 'Modelo para streams ao vivo',
      title: '🔴 {user} está AO VIVO!', body: '📺 **{title}**\n\n**{user}** está ao vivo agora! Venha assistir e apoiar!',
      fields: [{ name: 'Status da Plataforma', value: '🟢 **{platform}** — AO VIVO • 🎮 **{game}**' }],
  ...
  ru: {
    ...
    streamLive: { name: 'Анонс Стрима (Прямой Эфир)', desc: 'Шаблон для прямых трансляций',
      title: '🔴 {user} В ЭФИРЕ!', body: '📺 **{title}**\n\n**{user}** сейчас в прямом эфире! Приходите смотреть!',
      fields: [{ name: 'Статус Платформы', value: '🟢 **{platform}** — LIVE • 🎮 **{game}**' }],
  ...
  ar: {
    ...
    streamLive: { name: 'إعلان بث (مباشر)', desc: 'قالب للبث المباشر',
      title: '🔴 {user} مباشر الآن!', body: '📺 **{title}**\n\n**{user}** يبث مباشرة الآن! تعال شاهد وادعم!',
      fields: [{ name: 'حالة المنصة', value: '🟢 **{platform}** — مباشر • 🎮 **{game}**' }],
